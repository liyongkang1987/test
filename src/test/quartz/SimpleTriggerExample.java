...
public class SimpleTriggerExample {
	...
	public void run() throws SchedulerException {
		...
		System.out
				.println(jobDetail.getKey() + " will run at: " + date + " and repeat: " + simpleTrigger.getRepeatCount()
		...
		simpleTrigger = (SimpleTrigger) TriggerBuilder.newTrigger().withIdentity("trigger2", "group1")
				.startAt(startDate).build();
		...
		System.out.println(
				jobDetail.getKey() + " will [also] run at: " + date + " and repeat: " + simpleTrigger.getRepeatCount()
						+ " times, every " + simpleTrigger.getRepeatInterval() / 1000L + " seconds");
		// ------------------------------------------Job3
		// end-------------------------------------------------
		// ------------------------------------------Job4
